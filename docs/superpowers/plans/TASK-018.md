...
- `.claude/scripts/test_parse_slash_command.py`
- `.github/workflows/ci.yml`
- `.gitignore`
- `.harness/workflows/feature-development.md`
- `README.md`
- `HARNESS_USAGE_GUIDE.md`
- `docs/superpowers/plans/TASK-018.md`
- `docs/superpowers/plans/2026-05-18-control-plane-consistency.md`
- `docs/superpowers/specs/2026-05-18-control-plane-consistency-design.md`
...
- [x] **Placeholder scan**: 无待办占位符/"后续补充"/"留空待填"
...
```bash
pytest .harness/agent-guard/ -v && pytest .claude/scripts/test_parse_slash_command.py -v && python .claude/scripts/check-doc-sync.py
```

## success_criteria

- 全部 82+ 单元测试通过
- parse-slash-command 测试通过
- 文档同步检查 PASS
