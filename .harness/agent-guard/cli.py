...
def _transition_with_snapshot(
    ...
    snap_mgr.create_snapshot(task_id, required_context=req_ctx, plan_progress=plan_progress)
    return task
...
def cmd_patch(args) -> int:
    ...
    print(f"G4 {'PASSED' if g4['passed'] else 'ADVISORY'}: {g4['message']}")
